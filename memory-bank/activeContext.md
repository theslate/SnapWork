...
## Current Focus
Execute M01-WI-03 Import Minimal to reapply saved layouts on the current desktop, building on the completed desktop-scoped export foundation before tackling the remaining M01 work items.
...
- Completed M01-WI-12 by capturing desktop identifiers during export, adding `--desktop` selection with filtering, wiring COM desktop detection with exit codes (3/4), expanding tests, and refreshing README usage.
